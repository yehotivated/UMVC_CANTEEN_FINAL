...
{
    public partial class clerkDashboard : BaseDashboardForm
    {
        #region Constructor
        ...
        {
            AdminNavigation.Open(this, new clerkTransactions());
        }
        ...
        {
            AdminNavigation.Open(this, new clerkDashboard());
        }

        private void btnInventory_Click(object sender, EventArgs e)
        {
            AdminNavigation.Open(this, new clerkInventory());
        }
        private void btnSupplier_Click(object sender, EventArgs e)
        {
            AdminNavigation.Open(this, new clerkSupplier());
        }
